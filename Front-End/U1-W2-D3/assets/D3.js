...
for(let i=0;i<starWarsCharacters.length;i++){
  ...
  }else if(starWarsCharacters[i].mass>500 || starWarsCharacters[i].mass<700){
    console.log("Ship is half loaded");
  }else if(starWarsCharacters[i].mass>700 || starWarsCharacters[i].mass<900){
    console.log("Warning: Load is over 700");
  }else if(starWarsCharacters[i].mass>900 || starWarsCharacters[i].mass<1000){
    console.log("Critical Load: Over 900");
  }
  else if(starWarsCharacters.mass[i]>1000){
    console.log("Critical Load: Over 900");
  }
